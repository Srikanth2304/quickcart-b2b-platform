-- Flyway migration V1: Addresses + Order delivery snapshot (PostgreSQL)
...
CREATE TABLE IF NOT EXISTS addresses (
    ...
    -- auditing columns (matches BaseAuditableEntity)
...
-- Orders: add immutable delivery snapshot fields
